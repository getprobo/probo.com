---
title: Contributing
description: Guide to contributing platform support, posture checks, and fixes to the open-source Device Agent, including source paths and the security review process.
---

import { LinkCard, CardGrid, Aside } from "@astrojs/starlight/components";

The official Device Agent is open source. Contributions that improve platform
