...
[Device Agent security](/docs/product/device-agent/security) for the security
...
binary. See [Contributing to Device Agent](/docs/developers/api/agent/contributing)
