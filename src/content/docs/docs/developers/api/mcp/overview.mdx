...
description: Introduces the Probo MCP server, covering how connections authenticate, the 367 available tools, read-only testing, and the MCP Inspector.
---
...
[Model Context Protocol](https://modelcontextprotocol.io/docs/getting-started/intro). A connected client
...
Probo currently exposes **367 tools** generated from its server specification.
They cover organizations, identity, risks, controls, frameworks, evidence,
documents, assets, audits, findings, privacy, third parties, access reviews,
the compliance portal, webhooks, cookie consent, and other compliance
workflows.
