...
description: Introduces the Probo MCP server, covering how connections authenticate, the 361 available tools, read-only testing, and the MCP Inspector.
---
...
Probo currently exposes **361 tools** generated from its server specification.
