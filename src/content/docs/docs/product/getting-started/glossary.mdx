...
<GlossaryTable>
  ...
  <tr data-glossary-row id="agent-run">
    ...
    <td>
      ...
      agent run is distinct from a Device Agent posture collection on a device.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="compliance-portal">
    ...
    <td>
      ...
      Probo workspace. See{" "}
      <a href="/docs/product/compliance-portal">Compliance Portal overview</a>.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="custom-domain">
    <td>Custom domain</td>
    <td>
      An organization-owned hostname used for a Compliance Portal instead of its
      default Probo address.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="device">
    <td>Device</td>
    <td>
      An endpoint enrolled with Device Agent. Its record can include ownership,
  ...
  <tr data-glossary-row id="external-access">
    <td>External access</td>
    <td>
      A visitor’s approved permission to open a restricted Compliance Portal
      resource. If the portal has an NDA, exporting the resource also requires a
  ...
  <tr data-glossary-row id="membership">
    <td>Membership</td>
    <td>
      The relationship that grants a user a role (<code>OWNER</code>,{" "}
      <code>ADMIN</code>, <code>VIEWER</code>,<code>AUDITOR</code>, or{" "}
      <code>EMPLOYEE</code>) and access within a Probo organization. Managed
      under <strong>People</strong>. See
  ...
  <tr data-glossary-row id="nda">
    <td>NDA</td>
    <td>
      <strong>Non-Disclosure Agreement.</strong> An agreement a Compliance
      Portal visitor may be required to sign before exporting portal documents.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="portal-access-request">
    <td>Portal access request</td>
    <td>
      A visitor’s request to view one or more restricted Compliance Portal
      documents, pending the organization’s approval.
    </td>
  </tr>
  <tr data-glossary-row id="portal-file">
    <td>Portal file</td>
    <td>
      A file uploaded specifically for publication through a Compliance Portal,
      separate from a controlled Probo document.
    </td>
  </tr>
  <tr data-glossary-row id="portal-update">
    <td>Portal update</td>
    <td>
      An announcement published on a Compliance Portal and optionally sent to
      subscribed visitors through its mailing list.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="reference">
    <td>Reference</td>
    <td>
      A customer or partner name, logo, website, and optional description
      published in a Compliance Portal’s <strong>Trusted by</strong> section.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="resource-alias">
    <td>Resource alias</td>
    <td>
      A portal-specific URL slug for a published document or file, used to
      create a stable, readable public path.
    </td>
  </tr>
  ...
  <tr data-glossary-row id="visibility">
    <td>Visibility</td>
    <td>
      The Compliance Portal setting that determines whether content is public,
      restricted to approved visitors, or not published.
    </td>
  </tr>
