---
title: Windows
description: Install Device Agent on Windows with the signed MSI installer, enroll the device from the Probo console tray helper, and verify or uninstall it.
---

import { Steps } from "@astrojs/starlight/components";

The recommended way to set up Device Agent on a Windows computer is:
...
1. **Download the MSI**
   ...
   From the [Download page](/download), download the Windows `.msi` for the latest Device Agent release.
