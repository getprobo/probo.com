---
title: macOS
description: Install Device Agent on macOS with the signed universal package, enroll the device from the Probo console via the app deeplink, and verify it.
---

import { Steps } from "@astrojs/starlight/components";

The recommended way to set up Device Agent on a Mac is:
...
1. **Download the package**
   ...
   From the [Download page](/download), download the macOS `.pkg` for the latest Device Agent release.
