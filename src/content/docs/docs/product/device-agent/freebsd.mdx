---
title: FreeBSD
description: Install and enroll Device Agent on FreeBSD servers from the command line using install.sh or the CLI, and verify or uninstall the deployment.
---

Install and enroll Device Agent on FreeBSD from the command line. This path is for servers and other headless hosts where there is no tray or browser enrollment.
